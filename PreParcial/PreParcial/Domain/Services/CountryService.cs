...
{
    public class StateService : ICountryService
    {
        ...
        {
            return await _context.Countries.FirstOrDefaultAsync(c => c.Name == name); //FirstOrDefaultAsync es un método de EF CORE
        }
